...
namespace MurTree
{
class SpecialisedBinaryClassificationDecisionTreeSolver : public SpecialisedDecisionTreeSolverAbstract
{
public:
	//assumes the feature vectors ID are in the range of [0, ..., num_feature_vectors)
	SpecialisedBinaryClassificationDecisionTreeSolver(int num_features, int num_feature_vectors, bool use_incremental_frequencies); 
...
private:
	...
	SpecialisedBranchMisclassificationComputer penalty_computer_;
};
